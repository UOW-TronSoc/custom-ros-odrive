...
//
// Do not edit by hand. Each struct matches one ODrive CAN Simple command (cmd_id)
// with encode_buf/decode_buf for little-endian payloads. custom_odrive_node currently
// packs most TX/RX with byte_swap.hpp read_le/write_le; these types remain for
// shared tooling and completeness with upstream odrive_base.
