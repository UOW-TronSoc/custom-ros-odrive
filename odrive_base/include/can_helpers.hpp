...
/*
 * Bitfield pack/unpack used by the autogenerated can_simple_messages.hpp structs.
 * isIntel=true → little-endian bit layout (ODrive CAN Simple).
 * custom_odrive_node mostly uses byte_swap.hpp read_le/write_le for whole fields;
 * these helpers remain for DBC-style signal extraction in generated message types.
 */
